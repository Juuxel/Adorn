...
object AdornMenus {
    val MENUS = PlatformBridges.registrarFactory.create(RegistryKeys.SCREEN_HANDLER)
    ...
    val FURNITURE_WORKBENCH: MenuType<FurnitureWorkbenchMenu> by MENUS.register("furniture_workbench") { createType(FurnitureWorkbenchMenu::load) }
