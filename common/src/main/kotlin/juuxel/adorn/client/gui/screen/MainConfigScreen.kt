...
class MainConfigScreen(parent: Screen) : AbstractConfigScreen(TranslatableText("gui.adorn.config.title"), parent) {
    override fun init() {
        ...
        addDrawableChild(
            ButtonWidget(x, 40 + 2 * BUTTON_SPACING, BUTTON_WIDTH, 20, TranslatableText("gui.adorn.config.game_rule_defaults")) {
