...
public final class AdornItems {
    ...
    public static final RegisteredItem<Item> STONE_ROD = registerWithDescription("stone_rod", Item::new);
    public static final RegisteredItem<Item> MUG = registerWithDescription("mug", Item::new, () -> new Item.Properties().stacksTo(16));
    public static final RegisteredItem<Item> HOT_CHOCOLATE = registerWithDescription("hot_chocolate",
        DrinkInMugItem::new,
        () -> new Item.Properties().food(DRINK_FOOD_COMPONENT, Consumables.DEFAULT_DRINK).stacksTo(1)
    );
    public static final RegisteredItem<Item> SWEET_BERRY_JUICE = registerWithDescription("sweet_berry_juice",
        DrinkInMugItem::new,
        () -> new Item.Properties().food(DRINK_FOOD_COMPONENT, Consumables.DEFAULT_DRINK).stacksTo(1)
    );
    public static final RegisteredItem<Item> GLOW_BERRY_TEA = registerWithDescription("glow_berry_tea",
        DrinkInMugItem::new,
        () -> new Item.Properties()
    ...
    public static final RegisteredItem<Item> NETHER_WART_COFFEE = registerWithDescription("nether_wart_coffee",
        DrinkInMugItem::new,
        () -> new Item.Properties().food(DRINK_FOOD_COMPONENT, Consumables.DEFAULT_DRINK).stacksTo(1)
    );

    public static final RegisteredItem<Item> STONE_TORCH = ITEMS.register("stone_torch",
    ...
    public static final RegisteredItem<Item> GUIDE_BOOK = register("guide_book",
        settings -> new AdornBookItem(AdornCommon.id("guide"), settings),
        key -> new Item.Properties().rarity(Rarity.UNCOMMON)
    );
    public static final RegisteredItem<Item> TRADERS_MANUAL = register("traders_manual",
        settings -> new AdornBookItem(AdornCommon.id("traders_manual"), settings));

    public static final RegisteredItem<Item> WATERING_CAN = registerWithDescription("watering_can",
        WateringCanItem::new,
        () -> new Item.Properties()
    ...
    public static final RegisteredItem<Item> CONE = register("cone",
        ConeItem::new,
    ...
    public static final RegisteredItem<Item> CAUTION_SIGN = registerCautionSign("caution_sign",
        AdornBlocks.CAUTION_SIGN,
        AdornBlocks.WALL_CAUTION_SIGN
    );
    public static final RegisteredItem<Item> BEE_CAUTION_SIGN = registerCautionSign("bee_caution_sign",
        AdornBlocks.BEE_CAUTION_SIGN,
        AdornBlocks.BEE_WALL_CAUTION_SIGN
    );
    public static final RegisteredItem<Item> BOOK_CAUTION_SIGN = registerCautionSign("book_caution_sign",
        AdornBlocks.BOOK_CAUTION_SIGN,
        AdornBlocks.BOOK_WALL_CAUTION_SIGN
    );
    public static final RegisteredItem<Item> CLIFF_CAUTION_SIGN = registerCautionSign("cliff_caution_sign",
        AdornBlocks.CLIFF_CAUTION_SIGN,
        AdornBlocks.CLIFF_WALL_CAUTION_SIGN
    );
    public static final RegisteredItem<Item> FORBIDDEN_CAUTION_SIGN = registerCautionSign("forbidden_caution_sign",
        AdornBlocks.FORBIDDEN_CAUTION_SIGN,
        AdornBlocks.FORBIDDEN_WALL_CAUTION_SIGN
    );
    public static final RegisteredItem<Item> HELMET_CAUTION_SIGN = registerCautionSign("helmet_caution_sign",
        AdornBlocks.HELMET_CAUTION_SIGN,
        AdornBlocks.HELMET_WALL_CAUTION_SIGN
    );
    public static final RegisteredItem<Item> RAILS_CAUTION_SIGN = registerCautionSign("rails_caution_sign",
        AdornBlocks.RAILS_CAUTION_SIGN,
        AdornBlocks.RAILS_WALL_CAUTION_SIGN
    );
    public static final RegisteredItem<Item> SURPRISE_CAUTION_SIGN = registerCautionSign("surprise_caution_sign",
        AdornBlocks.SURPRISE_CAUTION_SIGN,
        AdornBlocks.SURPRISE_WALL_CAUTION_SIGN
    );

    private static RegisteredItem<Item> register(String name, Function<Item.Properties, Item> factory) {
        return register(name, factory, key -> new Item.Properties());
    }

    private static RegisteredItem<Item> registerWithDescription(String name, Function<Item.Properties, Item> factory) {
        return registerWithDescription(name, factory, Item.Properties::new);
    }

    private static RegisteredItem<Item> registerWithDescription(String name, Function<Item.Properties, Item> factory, Supplier<Item.Properties> settings) {
        return register(name, factory, key -> addDescription(settings.get(), key));
    }

    private static RegisteredItem<Item> register(String name, Function<Item.Properties, Item> factory, Function<ResourceKey<Item>, Item.Properties> settings) {
    ...
    private static RegisteredItem<Item> registerCautionSign(String name, Registered<? extends Block> standing, Registered<? extends Block> wall) {
        return register(
            name,
