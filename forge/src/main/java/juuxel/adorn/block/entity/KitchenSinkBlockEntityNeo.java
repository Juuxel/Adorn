...
public final class KitchenSinkBlockEntityNeo extends KitchenSinkBlockEntity implements BlockEntityWithFluidTank {
    ...
    public KitchenSinkBlockEntityNeo(BlockPos pos, BlockState state) {
        super(pos, state);
    }
