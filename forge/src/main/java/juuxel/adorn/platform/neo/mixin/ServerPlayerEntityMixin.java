...
abstract class ServerPlayerEntityMixin {
    @ModifyReceiver(method = "lambda$startSleepInBed$15", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/attribute/BedRule;canSleep(Lnet/minecraft/world/World;)Z"))
