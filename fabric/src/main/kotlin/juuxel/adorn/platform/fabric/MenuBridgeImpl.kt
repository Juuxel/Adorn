...
object MenuBridgeImpl : MenuBridge {
    ...
    override fun <M : Menu> create(factory: (syncId: Int, inventory: PlayerInventory) -> M): MenuType<M> =
        MenuType(MenuType.Factory(factory))

    override fun <M : Menu> create(factory: (Int, PlayerInventory, PacketByteBuf) -> M): MenuType<M> =
        ExtendedScreenHandlerType(ExtendedScreenHandlerType.ExtendedFactory(factory))
}
